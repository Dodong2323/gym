      ...
      builder: (context) {
        return AlertDialog(
          ...
          content: Column(
            ...
            children: [
              TextField(controller: titleController, decoration: InputDecoration(labelText: "Workout Type")),
              TextField(controller: durationController, decoration: InputDecoration(labelText: "Minutes"), keyboardType: TextInputType.number),
              TextField(controller: exercisesController, decoration: InputDecoration(labelText: "Exercises")),
              TextField(controller: exerciseNamesController, decoration: InputDecoration(labelText: "Exercise Info")),
            ],
          ),
          actions: [
            TextButton(
